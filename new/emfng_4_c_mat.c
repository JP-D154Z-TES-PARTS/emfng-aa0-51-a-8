...
/*********************************************************************/
/*  Version: aa0-51-a (4-cylinder)                                   */
/*********************************************************************/

/*********************************************************************/
/* �I�u�W�F�N�g�� |  ���Ό��o�ُ픻�蕔                              */
/* ���ӎ���       | �y����OBD�L�zAND�y4�C���z                        */
/*-------------------------------------------------------------------*/
...
#include <../inc/gllib.h>
#include <engsrc/espc/ejcc.h>           /* JEEFI,JEHIPFI_E,JEMFHOUKI,JEMFOTLV */
                                        /* JEOBDSIMUKE,JEOOBD,u1g_EJCC_NCYL */
                                        /* u1g_EJCC_USAMF,u1g_EJCC_JCUT,u1g_EJCC_ECUT,u1g_EJCC_CCUT,u1g_EJCC_CD34,u1g_EJCC_DUAL,JENGPF_E */
...
volatile const s2 s2s_emfng_MFDD = s2g_glround((1.4)/(256./128./256.)); /* m=emfng,lsb=256/128/256,ofs=,unit=% :EM�������َ��Η� */
...
volatile const u2 u2s_emfng_MFD1 = (u2)(((0.9)/(2./256./256.))+0.5);    /* m=emfng,lsb=2/256/256,ofs=,unit= :EM�������َ��Ό��o�� */
  #endif                                                                /* JEMFHOUKI */
#else                                                                   /* �y�G�}OT���ٌ���L�z */
volatile const s2 s2s_emfng_MFDD = s2g_glround((25.)/(256./128./256.)); /* m=emfng,lsb=256/128/256,ofs=,unit=% :EM�������َ��Η� */
volatile const u2 u2s_emfng_MFD1 = (u2)(((0.9)/(2./256./256.))+0.5);    /* m=emfng,lsb=2/256/256,ofs=,unit= :EM�������َ��Ό��o�� */
#endif                                                                  /* JEMFOTLV */
...
volatile const u1 u1s_emfng_MFSTOT = (u1)(((85.)/(1.))+0.5);            /* m=emfng,lsb=1,ofs=,unit=�� :�C���ʎ��Ή񐔔���l */
...
volatile const u1 u1g_emfng_CATN = (u1)(((1.)/(1.))+0.5);               /* m=emfng,lsb=1,ofs=,unit= :�o���N����ʂ̗L��(��:1,�L:2) */
...
volatile const s2 s2g_emfng_MFOTL = s2g_glround((25.)/(256./128./256.));    /* m=emfng,lsb=256/128/256,ofs=,unit=% :�G�}OT���َ��Δ��艺���l */
...
{
    6,7,0,
              X(20.),   X(35.),   X(50.),    X(70.),   X(85.),   X(100.),
    Y(800.),  Z(44.44), Z(40.),   Z(36.36),  Z(28.57), Z(19.05), Z(20.),
    Y(1600.), Z(38.1),  Z(33.33), Z(30.77),  Z(17.02), Z(14.04), Z(16.),
    Y(2400.), Z(32.),   Z(29.63), Z(25.),    Z(16.),   Z(10.),   Z(13.11),
    Y(3200.), Z(26.67), Z(25.),   Z(15.094), Z(10.),   Z(10.),   Z(10.),
    Y(4000.), Z(23.53), Z(20.),   Z(11.94),  Z(10.),   Z(10.),   Z(10.96),
    Y(4800.), Z(20.73), Z(17.02), Z(11.94),  Z(10.96), Z(10.96), Z(11.94),
    Y(5600.), Z(17.02), Z(11.94), Z(13.11),  Z(13.11), Z(11.94), Z(11.94)
};
#undef X
#undef Y
#undef Z
...
volatile const u1 u1s_emfng_mfcylbnk_tbl[] =
{
    /* t_mfcyl    0      1      2      3     */
    /* t_bnk */   X(0.), X(0.), X(0.), X(0.)
};
#undef X

/* L4(bank��ʖ�) �� emfng_CATN=2 ��emfok��bank��ʂƂ��ĎQ�Ƃ��邽�ߖ��Ή� */

/*---- emfng_mfwcyl_tbl --------------------------------------------*/
#define X(x) ((u1)(x))                                                  /* m=emfng,lsb=,ofs=,unit= : */
volatile const u1 u1g_emfng_mfwcyl_tbl[] =
{
    /* t_cylw     0            1           */
    /* t_bnk */   (u1)(0x0aU), (u1)(0x05U)
};
#undef X
